package eu.aplusteam.twittersearches;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final View.OnClickListener saveButtonListener =
            new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    boolean isQueryNotEmpty = !tag.isEmpty();
                    boolean isTagNotEmpty = !query.isEmpty();

                    if (isQueryNotEmpty && isTagNotEmpty) {
                        ((InputMethodManager)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tagEditText = ((TextInputLayout) findViewById(R.id.tagTextInputLayout))
                .getEditText();
        ...
        adapter = new SearchesAdapter(tags,
                itemClickListener,
    ...
    private void updateSaveFAB() {
        boolean isQueryEmpty = queryEditText.getText().toString().isEmpty();
        boolean isTagEmpty = tagEditText.getText().toString().isEmpty();

        if (isQueryEmpty || isTagEmpty) {
    ...
    private void shareSearch(String tag) {
        ...
        shareIntent.putExtra(Intent.EXTRA_INTENT,
                getString(R.string.share_message, urlString));
        shareIntent.setType("text/plain");

        startActivity(Intent.createChooser(
                shareIntent, getString(R.string.share_search)));
    }
